	...
	<div class="findBtn">
		...
		<div id="findIdForm" style="display: none;">
			<div class="form-container">
				<p>아이디 찾기</p>
				<form id="findIdForm2" action="/email/send-verification-code-id" method="post">
					...
					<div class="email-input">
						...
						<span>@</span>
						<!-- 직접 입력 폼 제작 필 -->
						<select id="findIdEmailDomain" name="emailDomain">
		...
		<div id="findPwForm" style="display: none;">
			<div class="form-container">
				<p>비밀번호 찾기</p>
				<form id="findPwForm2" action="/email/send-verification-code-pw" method="post">
