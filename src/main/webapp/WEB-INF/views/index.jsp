...
<body>
    ...
    <div class="login-overlay" id="loginOverlay" style="display: <%= (session.getAttribute("userId") == null) ? "flex" : "none" %>;">
	    <div class="login-form">
	    	<div class="images">
	    		<img src="../img/logo.png" alt="logo1" title="logo" class="picture">
	    		<img src="../img/LookForYourMovement.png" alt="moto" title="moto" class="picture">
	    	</div>
	        ...
	        <form action="/api/login" method="post" id="loginForm">
	            ...
	            <div class="password-container">
			        ...
			        <button type="button" id="togglePassword" class="eye-btn">
			        	<img src="../img/closed_eyes.svg" alt="Toggle Password" id="eyeIcon">
			        </button>
			    </div>
		    ...
		    function adjustNavLinks() {
	            ...
	            if (window.innerWidth <= 767) {
	                ...
	                navLinks.innerHTML = `
	                	<div class="myPage">
		                    <div class="user-info">
		                        <img src="../img/myPage_image.png" alt="myPage_image" title="myPage_image" class="picture">
		                        <div class="greeting">
	                ...
	                <div>
		                ...
		                <div id="logoutContainer">
		                    <form action="/api/logout" method="post" id="logoutForm">
		                        <button type="submit" id="logoutButton">로그아웃 <img src="../img/Frame.png" alt="logout_icon" class="logout_icon"></button>
		                    </form>
	                    <div>
	                `;
	            } else {
